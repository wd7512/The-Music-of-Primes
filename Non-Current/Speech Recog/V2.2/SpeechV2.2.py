...
def using_mic(lang):
    ...
    three = t.translate('Speak in - 3 - three',src='en',dest=lang)
    two = t.translate('Speak in - 2 - two',src='en',dest=lang)
    one = t.translate('Speak in - 1 - one',src='en',dest=lang)
    time.sleep(1)
    print(three.text)
    time.sleep(1)
    print(two.text)
    ...
    Micon = t.translate('Microphone on',src='en',dest=lang)
    Micoff = t.translate('Microphone off',src='en',dest=lang)
    print(Micon.text)
...
def question(ques,lan):
    ...
    while sp_out == False:
        ...
        sp_out = convert_speech(using_mic(lan[:2]),lan)
        if sp_out == False:
            pass
        else:
