...
```
We can see that the function returns the interval $0.1 \leq m < 2.8$ and we can verify these results that 0.1 is inclusive and 2.8 is non-inclusive as shown in the graph below.
